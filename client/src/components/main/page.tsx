  ...
  return (
    ...
    <div className='mx-auto  flex flex-col justify-center w-full px-10 py-20 bg-cover ' style={ {backgroundImage : `url(${bg.src})`}}>
        <div className='flex flex-col space-y-8 justify-center items-center'>
            ...
            <a href="/"><Button variant={'outline'} className='justify-center shadow-lg items-center text-lg font-semibold'>Get Started</Button></a>
        </div>
    </div>
    <div className='flex flex-col px-10 space-y-6 py-8 justify-center items-center'>
